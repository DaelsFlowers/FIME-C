...
const EDITOR = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      <ScrollView  >
        <Text style={{ fontSize: 42, fontWeight: '800', textAlign: "center" }}>EDITOR</Text>
        <View style={styles.content2}>
          ...
          {/* TITULO */}
          <Text style={{ fontSize: 32, fontWeight: "700", textAlign: "center" }}>TIPO</Text>
          ...
          <Text style={{ fontSize: 32, fontWeight: "700", textAlign: "center" }}>ESTADO</Text>
          <View style={{ alignItems: "center" }}>
            <SelectDropdown
              data={estado}
              buttonStyle={styles.drop}
