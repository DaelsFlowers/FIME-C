...
const CONFIGURACION = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      <ScrollView  >
        <Text style={{ fontSize: 42, fontWeight: '800', textAlign: "center" }}>CONFIGURACION</Text>
        <View style={styles.content2}>
          {/* NOMBRE */}
          <Text style={{ fontSize: 32, fontWeight: "700", textAlign: "center" }}>PORCENTAJE DE ADVERTENCIA:</Text>
        ...
        <TouchableOpacity onPress={() => { navigation.navigate('HomeScreen') }} style={{ marginVertical: 10, alignSelf: 'center', marginTop: 250 }}>
          <LinearGradient
            ...
            style={{ alignItems: 'center', justifyContent: 'center', margin: 5, height: 100, width: 150 }}>
            <Text style={{ color: '#FFFFFF', paddingVertical: 10, fontSize: 24, textAlign: 'center' }}>BORRAR HISTORIAL</Text>
          </LinearGradient>
        </TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
